...
import com.tapumandal.ecommerce.entity.dto.DeliveryProductDto;
...
@Entity
@Table(name = "wastage_product")
public class WastageProduct {
    ...
    public WastageProduct() {}

    public WastageProduct(DeliveryProductDto dpDto) {
