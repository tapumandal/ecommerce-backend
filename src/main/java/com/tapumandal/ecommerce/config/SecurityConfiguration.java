...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
                ...
                .antMatchers(apiVersionUrl+"/consumer/address/update").hasAnyAuthority("USER")
                ...
                .antMatchers(apiVersionUrl+"/consumer/{user_id}/cart/list").hasAnyAuthority("ADMIN", "USER")
                ...
                .antMatchers(apiVersionUrl+"/user").hasAnyAuthority("USER")
